...
Дополнение к домашнему заданию 27
...
Добавлена возможность авторизации и регистрации пользователей.
соответственно добавлены формы и шаблоны для регистрации авторизации пользователя, 
а так же просмотр данных пользователя.
