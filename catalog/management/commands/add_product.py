        ...
        """ 
               # Создаем категории (БЕЗ распаковки!)
                ...
                for product_data in products:  # Переименовал переменную
                    ...
                    if created:
                        self.stdout.write(
                            self.style.SUCCESS(f'Successfully added product: {product.title}'))
                    else:
